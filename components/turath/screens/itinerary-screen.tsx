...
import { ChevronLeftIcon, WalkingIcon, CarIcon, BusIcon, NavigationIcon, CheckIcon, ClockIcon, MapPinIcon } from '../icons'
        ...
        <div className="flex gap-2 mb-4">
          {[
            ...
            <button
              ...
              className={cn(
                "flex-1 py-2 px-3 rounded-xl flex items-center justify-center gap-2 transition-all text-sm font-medium",
                transportMode === id
          ...
          <div className="space-y-4">
            {ITINERARY_DATA.stops.map((stop, index) => (
              <div key={stop.id} className="flex gap-4">
                ...
                {/* Stop card */}
                <div className={cn(
                  "flex-1 rounded-2xl overflow-hidden border transition-all",
                  stop.completed 
