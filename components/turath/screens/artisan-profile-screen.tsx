...
const ARTISAN_DATA = {
  ...
  bioAr: 'حرفية زليج من الجيل الثالث متخصصة في فن الفسيفساء المغربي التقليدي.',
  followers: 2340,
  following: false,
}
    ...
    <div className="h-full flex flex-col overflow-y-auto">
      ...
      <div className="px-4 pb-6 bg-card border-b border-border">
        <div className="flex items-start gap-4">
          <div className="relative">
            <div 
              ...
              style={{ backgroundImage: `url(${ARTISAN_DATA.photo})` }}
            />
            {ARTISAN_DATA.verified && (
              <VerifiedIcon className="absolute -bottom-1 -right-1 w-6 h-6 text-secondary" />
            )}
          </div>
        ...
        <div className="flex items-center gap-3 mt-4">
          ...
          <button className="py-3 px-6 bg-accent text-accent-foreground rounded-2xl font-medium">
            Contact
          </button>
        </div>
      ...
      <div className="flex border-b border-border bg-card">
        {[
          ...
          { id: 'products' as const, label: 'Shop' },
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-1">
                      {Array.from({ length: review.rating }).map((_, i) => (
                        <StarIcon key={i} className="w-3 h-3 text-accent" filled />
                      ))}
                    </div>
                  </div>
