...
const ARTISAN = {
  ...
  followers: 3870,
  following: false,
  bio: "Fourth-generation master potter from the heart of Safi's famous pottery quarter. Hassan specialises in hand-thrown pieces glazed with the iconic cobalt-blue, turquoise, and terracotta pigments that have made Safi ceramics world-renowned for over five centuries.",
  yearsExp: 28,
  piecesSold: 1400,
}
...
const PRODUCTS = [
  {
    id: '1',
    name: 'Hand-Thrown Bowl',
    price: 680,
    image: '/artisan/poterry%201.jpg',
    description: 'Classic cobalt-blue glazed serving bowl, 28 cm ø',
  },
  {
    id: '2',
    ...
    description: 'Tall narrow-neck vase with floral Berber motifs',
  },
  {
    id: '3',
    name: 'Tagine Set',
    ...
    description: 'Functional hand-painted tagine — serves 2',
  },
  {
    id: '4',
    name: 'Wall Plate (30 cm)',
    price: 780,
    image: '/artisan/poterry%204.jpg',
    description: 'Decorative plate with geometric Andalusian pattern',
  },
  {
    id: '5',
    name: 'Espresso Cup Set ×4',
    price: 520,
    image: '/artisan/pottery%204.jpg',
    description: 'Set of 4 tiny hand-painted espresso cups',
  },
  {
    id: '6',
    name: 'Pitcher',
    ...
    description: 'Large pouring pitcher, turquoise & white glaze',
  },
]
...
const REVIEWS = [
  {
    ...
    initials: 'AD',
    rating: 5,
    text: 'The tagine set is absolutely gorgeous — unboxed it live on video and had 40k views. Authentic quality that speaks for itself.',
    date: '3 days ago',
  },
  {
    id: '2',
    ...
    initials: 'YM',
    rating: 5,
    text: 'Ordered the decorative vase as a wedding gift. Hassan even engraved a personal message. Outstanding!',
    date: '2 weeks ago',
  },
  {
    id: '3',
    ...
    initials: 'CB',
    rating: 5,
    text: 'I visited his workshop in Safi and watched him throw the bowl I ordered. An experience I will never forget.',
    date: '1 month ago',
  },
]
...
export function ArtisanProfileScreen({ isDark }: ArtisanProfileScreenProps) {
  ...
  const [isFollowing, setIsFollowing] = useState(ARTISAN.following)
  ...
  return (
    <div className="h-full flex flex-col overflow-y-auto">
      ...
      <div className="pt-12 px-4 pb-4 flex items-center justify-between bg-card">
        ...
        <span className="text-sm font-semibold text-foreground">Artisan Profile</span>
      ...
      <div className="px-4 pt-4 pb-4 bg-card border-b border-border">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div className="relative flex-shrink-0">
              <div
                ...
                style={{ backgroundImage: `url(${ARTISAN.photo})` }}
              />
              {ARTISAN.verified && (
            ...
            {/* Name + craft */}
            <div>
              <h1 className="text-lg font-bold text-foreground">{ARTISAN.name}</h1>
              <p className="text-xs text-accent font-serif" dir="rtl">{ARTISAN.nameAr}</p>
          ...
          <div className="flex flex-col items-center bg-muted rounded-xl px-3 py-2 flex-shrink-0">
            <div className="flex items-center gap-0.5">
              ...
              <span className="text-sm font-bold text-foreground">{ARTISAN.rating}</span>
            </div>
            <span className="text-[9px] text-muted-foreground">{ARTISAN.reviewCount} reviews</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 mt-3 flex-wrap">
          ...
          <span className="text-xs text-muted-foreground">{ARTISAN.city}, Morocco</span>
          <span className="text-muted-foreground/40 mx-1">·</span>
          <span className="text-xs text-muted-foreground">{ARTISAN.yearsExp} yrs experience</span>
          <span className="text-muted-foreground/40 mx-1">·</span>
          <span className="text-xs text-muted-foreground">{ARTISAN.piecesSold.toLocaleString()} pieces sold</span>
        </div>
        ...
        {/* Bio */}
        <p className="text-sm text-muted-foreground mt-3 leading-relaxed">{ARTISAN.bio}</p>
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="flex items-center gap-4 p-4 bg-card rounded-2xl border border-border">
              <div className="flex flex-col items-center">
                <span className="text-4xl font-black text-foreground">{ARTISAN.rating}</span>
